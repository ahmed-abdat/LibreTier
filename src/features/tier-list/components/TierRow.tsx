      ...
      >
        ...
        {isEditing && !isExporting ? (
          <textarea
            ...
            rows={1}
            aria-multiline="true"
            className="w-full resize-none overflow-hidden border-0 bg-transparent p-1 text-center font-bold wrap-break-word outline-none ring-0 shadow-none focus:border-0 focus:outline-none focus:ring-0 focus:shadow-none"
            style={{
              color: textColor,
              fontSize: "14px",
              lineHeight: "1.2",
            ...
            <PopoverTrigger asChild>
              <Button
                ...
                className={cn(
                  ...
                  // Desktop (md+): smaller size (20x20), hover-reveal
                  "h-6 w-6 md:h-5 md:w-5",
                  "bg-black/40 hover:scale-110 hover:bg-black/60 active:scale-95",
                  "border border-white/20 shadow-sm",
                  "opacity-60 md:opacity-0 md:group-hover/row:opacity-100",
                  "transition-all duration-200"
                )}
              >
                <Settings2
                  className="h-3 w-3 text-white md:h-2.5 md:w-2.5"
                  aria-hidden="true"
                />
              </Button>
            </PopoverTrigger>
